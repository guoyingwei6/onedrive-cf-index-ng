...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'guoyingwei6@outlook.com',
  ...
  // protectedRoutes: ['/Backups_NWAFU/05.其它备份/00.Private'],
  protectedRoutes: [/Backups_NWAFU/Others/00.Private],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:onedrive@guoyingwei.email',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/guoyingwei6',
    },
  ],
